      ...
      <div className="classes-book-now">
        ...
        <div className="overlap">
          <img
            className="image"
            alt="Image2"
            src="https://img.freepik.com/premium-photo/couple-training-gym_186382-6593.jpg"
          />
          <div className="div">ADVANCED</div>
        </div>
        <div className="overlap-group">
          <img
            className="img"
            alt="Image1"
            src="https://images.pexels.com/photos/2780762/pexels-photo-2780762.jpeg?auto=compress&cs=tinysrgb&w=400"
          />
          <div className="text-wrapper-2">INTERMEDIATE</div>
        </div>
        <div className="overlap-2">
          <img
            className="image-2"
            alt="Image3"
            src="https://images.pexels.com/photos/1886487/pexels-photo-1886487.jpeg?auto=compress&cs=tinysrgb&w=400"
          />
          <div className="div">BEGINNER</div>
        </div>
        <p className="join-our-advanced">
          ...
          <span className="text-wrapper-3">
            {" "}
            our advanced gym class designed for seasoned fitness enthusiasts
          </span>
        </p>
        <p className="achieve-your-fitness">
          <span className="span">Achieve</span>
