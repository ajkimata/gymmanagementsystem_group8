    ...
    <div className="user-login-page">
      ...
      <div className="overlap">
        <div className="frame">
          ...
          <div className="group-2">
            <div className="overlap-3">
              <NextLink href="/next">NEXT</NextLink> {/* Use the NextLink styled component */}
            </div>
          </div>
          <div className="group-3">
            <p className="don-t-have-account">
              ...
              <span className="text-wrapper-6">
                <RegisterLink href="/register">Register Now</RegisterLink> {/* Use the RegisterLink styled component */}
              </span>
            </p>
            <div className="google-g-logo-wrapper">
              <img
